...
- [x] Instalação de dependências concluída (`npm install`).
- [x] Servidor de desenvolvimento iniciado localmente.
...
- [x] Novos tipos: WhatsApp, PIX, Instagram, YouTube, Email, SMS. (LinkedIn removido)
